...
export async function linkAccounts(operations: Operations, options: ICreateLinkOptions): Promise<ICreatedLinkOutcome> {
    ...
    if (!options.skipSendingMail) {
      setImmediateAsync(sendLinkedAccountMail.bind(null, operations, link, mailAddress, correlationId, false /* do not throw on errors */));
    }
  ...
  async function sendLinkedAccountMail(operations: Operations, link: ICorporateLink, mailAddress: string | null, correlationId: string | null, throwIfError: boolean): Promise<void> {

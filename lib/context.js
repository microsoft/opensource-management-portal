...
>>>>>>> 97476762b0b695fd3cabb28ebe493e12c7d383c0
const RedisHelper = require('./redis');

/*eslint no-console: ["error", { allow: ["warn"] }] */

function OpenSourceUserContext(options, callback) {
  console.log('ctor: OpenSourceUserContext');
  var self = this;
  ...
  this.createModernUser = function (id, login) {
    console.warn('the user class is gone, so modernUser calls will have issues...');
    modernUser = {
      login: login,
      id: id,
    };
